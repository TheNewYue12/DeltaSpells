...
public class RudeBusterRenderer extends EntityRenderer<Projectile>  {
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(DeltaSpellsMod.MODID, "rude_buster_projectile"), "main");
    ...
    public RudeBusterRenderer(Context context, float scale) {
        super(context);
